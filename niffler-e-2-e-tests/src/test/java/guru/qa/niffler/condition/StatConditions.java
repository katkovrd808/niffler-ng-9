    ...
    return new WebElementsCondition() {
      ...
      public CheckResult check(Driver driver, List<WebElement> elements) {
        ...
        for (int i = 0; i < elements.size(); i++) {
          ...
          actualBubbles.add(new Bubble(Color.byRgba(rgba), text));
          if (passed) {
    ...
    return new WebElementsCondition() {
      ...
      public CheckResult check(Driver driver, List<WebElement> elements) {
        ...
        final List<Bubble> actualBubbles = elements.stream()
          .map(e -> new Bubble(
              Color.byRgba(e.getCssValue("background-color")),
              e.getText()
            )
    ...
    return new WebElementsCondition() {
      ...
      public CheckResult check(Driver driver, List<WebElement> elements) {
        ...
        final Set<Bubble> actualBubbles = elements.stream()
          .map(e -> new Bubble(Color.byRgba(e.getCssValue("background-color")), e.getText()))
